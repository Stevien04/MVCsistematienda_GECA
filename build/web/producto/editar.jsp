...
<%
    ...
    clsProducto producto = (clsProducto) request.getAttribute("producto");
...
<head>
    ...
    <title>Editar Producto - Sistema Tienda</title>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="container-fluid p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="h4 mb-1">
                        <i class="fas fa-edit me-2 text-primary"></i>Editar Producto
                    </h2>
                    <p class="text-muted mb-0">Modificar información del producto</p>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        <div class="d-flex justify-content-center align-items-center mb-3">
                            <div class="color-preview me-3" style="background-color: <%= producto.getCodigoHex() != null ? producto.getCodigoHex() : "#6c757d" %>; width: 40px; height: 40px;"></div>
                            <div class="text-start">
                                <h5><%= producto.getNombreproducto() %></h5>
                                <div>
                                    <span class="badge product-badge bg-primary me-2"><%= producto.getNombrecategoria() %></span>
                                    <span class="badge product-badge bg-secondary me-2"><%= producto.getNombremodelo() %></span>
                                    <span class="badge product-badge bg-info"><%= producto.getNombrecolor() %></span>
                                </div>
                                <p class="text-muted mb-0">ID: <%= producto.getIdproducto() %> | Stock: <%= producto.getStock() %> | Precio: S/ <%= producto.getPrecio() %></p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nombre" required 
                                           value="<%= producto.getNombreproducto() %>" maxlength="100">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-semibold">Descripción</label>
                                    <textarea class="form-control" name="descripcion" rows="2" 
                                              maxlength="255"><%= producto.getDescripcion() != null ? producto.getDescripcion() : "" %></textarea>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <select class="form-select" name="idCategoria" required>
                                        ...
                                        <% if (listaCategorias != null) { 
                                            for (clsCategoria categoria : listaCategorias) { %>
                                                <option value="<%= categoria.getIdcategoria() %>" <%= categoria.getIdcategoria() == producto.getIdcategoria() ? "selected" : "" %>>
                                    ...
                                    <select class="form-select" name="idModelo" required>
                                        ...
                                        <% if (listaModelos != null) { 
                                            for (clsModelo modelo : listaModelos) { %>
                                                <option value="<%= modelo.getIdmodelo() %>" <%= modelo.getIdmodelo() == producto.getIdmodelo() ? "selected" : "" %>>
                                        ...
                                        <% if (listaColores != null) { 
                                            for (clsColor color : listaColores) { %>
                                                <option value="<%= color.getIdcolor() %>" 
                                                        data-hex="<%= color.getCodigoHex() != null ? color.getCodigoHex() : "#6c757d" %>"
                                                        <%= color.getIdcolor() == producto.getIdcolor() ? "selected" : "" %>>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="precio" required 
                                           value="<%= producto.getPrecio() != null ? producto.getPrecio() : "0.00" %>" min="0">
                                </div>
                                <div class="col-md-6 mb-3">
