            ...
            <div class="container-fluid p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="${pageContext.request.contextPath}/ControladorEmpleado?accion=exportarExcel" class="btn btn-outline-success">
                            <i class="fas fa-file-excel me-2"></i>Excel
                        </a>
                        <a href="${pageContext.request.contextPath}/ControladorEmpleado?accion=exportarPdf" class="btn btn-outline-danger">
